...
public class DescuentoEnSegundoProducto implements Function<Compra, Float> {
		...
		public static DescuentoEnSegundoProducto instance(String productoCondicion, String productoDescuento, int porcentaje) {
			return new DescuentoEnSegundoProducto(productoCondicion, productoDescuento, porcentaje);
		}
		...
		public Float apply(Compra input) {
			...
			if( cantidadProductoCondicion <= cantidadProductoDescuento){
				return cantidadProductoCondicion * this.precioDescuento * this.porcentaje/ 100.0f;
			}
			else return cantidadProductoDescuento * this.precioDescuento * this.porcentaje/ 100.0f;
		}
